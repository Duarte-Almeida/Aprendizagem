...
\begin{document}
    ...
    \begin{questions}
        ...
        \begin{itemize}
            ...
            \item both an increased number of considered features (according to decreasing mutual information) and tree depth make splits more granular and the rules more specific to the regularities of the training data, making it harder for the model to generalize to unseen data (i.e., overfitting). Hence the always-rising tendency in training accuracy and a decay in testing accuracy from a certain tree depth/no. of features onwards.

...
def kNN_cross_validation(inputs, outputs):
    ...
    test_errors = {}
    for k in (3, 5, 7):      
       test_errors[k]=model_selection.cross_validate(estimator=\
neighbors.KNeighborsClassifier(n_neighbors=k), X = inputs, y = outputs, scoring = "accuracy", cv = kf)["test_score"]
